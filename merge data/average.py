...
def main(bashPath, fileNames, flag, savePath, compress=True):
    for fileName in fileNames:
        ...
        filtered_missing_ranges = {col: meta.missing_ranges[col] for col in meta.missing_ranges if
...
if __name__ == '__main__':
    ...
    flag = 'CNTSCHID'
    savePath = './teacher_average.sav'
    main(bashPath, fileNames, flag, savePath, compress=True)
